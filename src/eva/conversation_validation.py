...
async def handle_conversation_logic(conversation: Conversation, user_id: Optional[str] = None) -> dict:
    ...
    return tob_conversation_logic(conversation_id, validate_message, conversation.message, first_interaction, user_id)
